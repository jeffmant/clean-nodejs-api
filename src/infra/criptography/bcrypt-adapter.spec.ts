...
describe('Bcrypt Adapter', () => {
  ...
  test('Should throw if hash throws', async () => {
    ...
    hashSpy.mockResolvedValueOnce(new Promise((_resolve, reject) => reject(new Error())))
  ...
  test('Should return false when compare fails', async () => {
    ...
    ReturnType<(key: string) => Promise<boolean>>,
    Parameters<(key: string) => Promise<boolean>>>
    compareSpy.mockResolvedValueOnce(new Promise((resolve) => resolve(false)))
    const isValid = await sut.compare('any_value', 'any_hash')
  ...
  test('Should throw if compare throws', async () => {
    ...
    ReturnType<(key: string) => Promise<string>>,
    Parameters<(key: string) => Promise<string>>>
    compareSpy.mockResolvedValueOnce(new Promise((_resolve, reject) => reject(new Error())))
